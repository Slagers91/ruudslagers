...
const Hero = () => (
  ...
  transition={{
    ...
    <div className='flex flex-row justify-between items-center w-full'>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodology to identify the credit cards most likely to fit your needs. We eamine annual percentage rates, annual fees.</p>
    </div>
